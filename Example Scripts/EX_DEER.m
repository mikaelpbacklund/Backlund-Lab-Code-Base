...
params.RF2Frequency = 2;%GHz. Overwritten by scan if frequency selected
...
params.RF1ResonanceFrequency = 2.87;
params.piTime = 100;
params.tauTime = 500;
...
params.timePerDataPoint = 5;%seconds
...
params.IQPreBufferDuration = 20;
params.IQPostBufferDuration = 20;
nIterations = 10;
SRSAmplitude = 10;
