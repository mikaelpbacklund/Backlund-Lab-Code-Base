...
%    RFFrequency
   ...
   master.PB.command.direction = 'CONTINUE';
   master.PB.command.duration = collectt/spulse-25;
   PBAddSequence
   end
   
   master.PB.command.output = 1;
   master.PB.command.direction = 'CONTINUE';
   master.PB.command.duration = 800;
   PBAddSequence
   
   master.PB.command.output = 21;
   master.PB.command.direction = 'CONTINUE';
   master.PB.command.duration = 25;
   PBAddSequence
   ...
   master.PB.command.output = 1 + sigref;
   master.PB.command.direction = 'CONTINUE';
   master.PB.command.duration = 3175; 
   PBAddSequence
