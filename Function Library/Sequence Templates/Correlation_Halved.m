function Correlation_Halved(templateInputs)
...
if strcmp(templateInputs,'inputs request')
   ...
   master.gui.PSE.inputNames(12) = "Signal or reference";
   ...
   master.gui.scan.addresses = firstaddress;
   master.gui.scan.starts = startdur;%Starting value for each address respectively
   master.gui.scan.ends = enddur;%Starting value for each address respectively
