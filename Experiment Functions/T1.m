...
requiredParams = {'scanBounds','collectionType'};
...
instrumentNames = ["pulse blaster","daq"];
instrumentConfigs = [c2s(p.pulseBlasterConfig),c2s(p.DAQConfig)];
...
[ex.pulseBlaster,scanInfo] = T1_template(ex.pulseBlaster,sentParams);
