function ex = Correlation(ex,p)

requiredParams = {'tBounds','tStepSize','collectionType','RFResonanceFrequency',...
   'piTime','nXY','setsXYN','tauDuration'};
...
scanStartInfo(ex.scan.nSteps,scanInfo.meanSequenceDuration*1e-9 + ex.forcedCollectionPauseTime*1.5,p.nIterations,.28)
