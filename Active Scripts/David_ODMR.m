...
%Required
p.scanBounds = [2.8 2.84]; %Frequency bounds
...
p.optimizationSteps = {-1:0.2:1}; %Locations the stage will move relative to current location
...
p.percentageForcedOptimization = .5; %see below (0 to disable)
