...
nDataPointDeviationTolerance = 0.0005;%How precies measurement is. Lower number means more exacting values, could lead to repeated failures
...
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{},5000,'Start Buffer');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{'AOM',},50000,'Initialization');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{},20000,'Drive Off');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{'AOM'},200,'AOM Delay');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{'AOM','Data'},1000,'Reference Data Collection');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{},5000,'Middle Buffer');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{'AOM','Signal'},50000,'Initialization');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{'RF','Signal'},20000,'RF Drive');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{'AOM','Signal'},200,'AOM Delay');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{'AOM','Signal','Data'},1000,'Signal Data Collection');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{'Signal'},5000,'End Buffer');
