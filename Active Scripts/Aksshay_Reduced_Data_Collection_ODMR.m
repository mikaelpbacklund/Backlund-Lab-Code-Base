...
sequenceTimePerDataPoint = 10;%Before factoring in forced delay and other pauses
...
nDataPointDeviationTolerance = .001;%How precies measurement is. Lower number means more exacting values, could lead to repeated failures
...
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{},100000,'Start Buffer');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{'AOM',},50000,'Initialization');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{},50000,'Drive Off');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{'AOM'},1300,'DAQ Delay Compensation');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{'AOM','DAQ'},1000,'Reference Data Collection');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{},100000,'Middle Buffer');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{'AOM','Signal'},50000,'Initialization');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{'RF','Signal'},50000,'RF Drive');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{'AOM','Signal','RF'},1300,'AOM Delay');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{'AOM','Signal','DAQ','RF'},1000,'Signal Data Collection');
ex.pulseBlaster = condensedAddPulse(ex.pulseBlaster,{'Signal'},100000,'End Buffer');
