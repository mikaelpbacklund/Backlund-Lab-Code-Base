...
instr{3}.nTotalLoops = 300;%Number of times entire sequence is repeated
instr{3}.useTotalLoop = true;
...
for ii = 1:nIterations
   ...
   while ~all(ex.odometer == [ex.scan.nSteps])
      ...
      if datetime-lastOptTime > duration(0,.5,0)%Check if last optimization was over 30 seconds ago
