function XYn_Halved(templateInputs)
...
if strcmp(templateInputs,'inputs request')
   ...
   master.gui.PSE.inputNames(3) = "τ (real) start";
   master.gui.PSE.inputNames(4) = "τ (real) end";
   ...
   master.gui.PSE.inputNames(10) = "AOM buffer";
   master.gui.PSE.inputNames(11) = "Signal or reference";
   ...
   signalHalf = templateInputs{11};
   
   if strcmp(signalHalf,"s") || strcmp(signalHalf,"S") || strcmp(signalHalf,"sig") || strcmp(signalHalf,"Sig") || strcmp(signalHalf,"signal") || strcmp(signalHalf,"Signal")
      signalHalf = true;
   elseif strcmp(signalHalf,"r") || strcmp(signalHalf,"R") || strcmp(signalHalf,"ref") || strcmp(signalHalf,"Ref") || strcmp(signalHalf,"reference") || strcmp(signalHalf,"Reference") 
      signalHalf = false;
   else
      error('Invalid signal or reference input. Must be s/S/sig/Sig/signal/Signal or r/R/ref/Ref/reference/Reference')
   end
   ...
   if ~master.NIDAQ.confocal
      ...
      %16.1 - S/R for wide field
      master.PB.command.description = 'WF signal/reference';
      master.PB.command.output = 4+1;
      master.PB.command.direction = 'CONTINUE';
      master.PB.command.duration = 25;
      PBAddSequence
   ...
   master.gui.scan.addresses = addresses;%Addresses that will be overwritten   
