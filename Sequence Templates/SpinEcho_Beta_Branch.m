function SpinEcho_Beta_Branch(templateInputs)
...
if strcmp(templateInputs,'inputs request')
    ...
    master.gui.PSE.inputNames(9) = "I/Q buffer pre*";
    master.gui.PSE.inputNames(10) = "I/Q buffer post*";
    master.gui.PSE.inputNames(11) = "I/Q pre duration*";
    master.gui.PSE.inputNames(12) = "I/Q post duration*";
else
    ...
    preBuffer = templateInputs{9};
    postBuffer = templateInputs{10};
    preDuration = str2double(templateInputs{11});
    postDuration = str2double(templateInputs{12});
    ...
    if preBuffer
        tauReduction = tauReduction + preDuration;
    end
    if postBuffer
        tauReduction = tauReduction + postDuration;
    end
